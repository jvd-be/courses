      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col  md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            {/* فرم عضویت در خبرنامه (اختیاری) */}
            <form className="flex items-center space-x-2">
              <input
                type="email"
                placeholder="ایمیل خود را وارد کنید"
                className="bg-white dark:bg-gray-700 text-sm text-gray-700 dark:text-gray-300 py-2 px-4 rounded-md focus:outline-none focus:ring focus:border-blue-300"
              />
              <button className="bg-blue-500 hover:bg-blue-600 text-white text-sm py-2 px-4 rounded-md transition-colors duration-300">
                عضویت
              </button>
            </form>
          </div>
